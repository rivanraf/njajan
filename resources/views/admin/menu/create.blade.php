        ...
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                <form action="{{ route('admin.menu.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        <x-input-label for="name" :value="__('Nama Menu')" class="text-sm font-semibold capitalize" />
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        <div>
                            <x-input-label for="category_id" :value="__('Kategori')" class="text-sm font-semibold capitalize" />
                        ...
                        <div>
                            <x-input-label for="price" :value="__('Harga (Rp)')" class="text-sm font-semibold capitalize" />
                    ...
                    <div class="mb-4">
                        <x-input-label for="description" :value="__('Deskripsi')" class="text-sm font-semibold capitalize" />
                    ...
                    <div class="mb-4">
                        <x-input-label for="type" :value="__('Pilihan Varian (Pisahkan dengan koma)')" class="text-sm font-semibold capitalize" />
                    ...
                    <div class="mb-6">
                        <x-input-label for="image" :value="__('Foto Menu')" class="text-sm font-semibold capitalize" />
