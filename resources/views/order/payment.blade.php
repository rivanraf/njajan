        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (payButton && paymentForm) {
                payButton.addEventListener('click', function(e) {
                    e.preventDefault(); // Kunci browser agar tidak refresh halaman sepihak

                    // Kunci tombol secara agresif agar tidak bisa di-klik dua kali (Anti Duplikasi Data)
                    ...
                    // SKENARIO QRIS (MIDTRANS)
                    // Karena Controller Anda mengembalikan HTML (return view), form harus dikirim 
                    // langsung secara konvensional (Native Submit) setelah tombol dikunci.
                    // Ini menjamin hanya 1 data order yang terbentuk di database lokal maupun hosting.
                    paymentForm.submit();
                });
            }
        });
